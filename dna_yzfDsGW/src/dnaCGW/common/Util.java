 ...
 */
public class Util {
	public static float Str12ToAmount(String src) {
		float res;
		if (src.length() != 12) {
			ToolKit.writeLog("Util", "������ַ��Ȳ���12:", src);
			return -1;
		}
		if (!isNumber(src)) {
			ToolKit.writeLog("Util", "����Ĳ��������ַ�", src);
			return -1;
		}
		res = Integer.parseInt(src.substring(0, 10)); // �����
		res += Integer.parseInt(src.substring(10, 12)) * 0.01;// С���
		return res;
	}

	public static char byte2Char(byte no) {
	...
	public static boolean isNumber(String num) {
		byte[] temp;
		try {
			temp = num.getBytes("ASCII");
		} catch (UnsupportedEncodingException e) {
			ToolKit.writeLog("Util", "���ASCII�뽫Stringתbyte[]ʱʧ�ܣ�", e);
			return false;
		}
	...
	/**
	 * 
	 * bcd strתbytes,���룺86AE�������10000110 10011110 ����ı�����0-9 a-f
	 * A-F��22�����������BCD�ַ�ת�ֽڲ��ϲ�����ֽ�����
	 */
	 ...
	 * 
	 * bytesתBCD�������룺01001100
	 * 00011000(bytes[0]=01001100,bytes[1]=00011000)�������4C18
	 */
	 ...
	 * 
	 * ������ת�����ƴ������룺00010000
	 * 00000001(bytes[0]=00010000,bytes[1]=00000001)�������0001000000000001
	 */
	...
	public static String bin2BinStr(byte bytes) {
		...
		temp.append((byte) ((bytes & 0x80) >>> 7));
		temp.append((byte) ((bytes & 0x40) >>> 6));
		temp.append((byte) ((bytes & 0x20) >>> 5));
		temp.append((byte) ((bytes & 0x10) >>> 4));
		temp.append((byte) ((bytes & 0x08) >>> 3));
		temp.append((byte) ((bytes & 0x04) >>> 2));
		temp.append((byte) ((bytes & 0x02) >>> 1));
		temp.append((byte) ((bytes & 0x01)));
		return temp.toString();
	}
	...
	/**
	 * 
	 * 10���ƴ�תΪBCD��(�ֽ�����)�����룺0123456789�������00000001 00100011 01000101 01100111
	 * 10001001 ����ı�����0-9 a-f A-F��22���ַ� ������󲹡�0���������Ҳ���F��
	 */
	...
	/**
	 * 
	 * �����ƴ�ת������(�ֽ�����)�����룺00110100 01110001 11000001(24�ַ�)�������00110100 01110001
	 * 11000001(3�ֽ�) ������ַ�ֻ�ܰ�0��1
	 */
	public static byte[] binStr2Bin(String str) {
		byte[] temp = str.getBytes();
		if (str.length() == 0) {
			throw new RuntimeException("�ַ���Ϊ�գ�ת��������ʧ��");
		}
		if (temp.length % 8 != 0) {
			throw new RuntimeException("�ַ�'" + str + "'���Ȳ���8�ı���ת��������ʧ��");
		}
		for (int i = 0; i < temp.length; i++) {
	...
	/**
	 * ����ת2���ƣ��ҿ�����'0'(bit) ���룺60��2 �����00000000 00111100 (0x00,0x3C)
	 */
	...
	public static String getUpopIdcT(String idcType) {
		if (!Strings.isNullOrEmpty(idcType)) {
			String idcT = idcType.replaceAll("IdcardType.", "");
			if ("01".equals(idcT)) {
				return "01";
			} else if ("02".equals(idcT)) {
				return "03";
			} else if ("03".equals(idcT)) {
				return "07";
			} else if ("04".equals(idcT)) {
				return "05";
			} else if ("05".equals(idcT)) {
				return "04";
			} else if ("06".equals(idcT)) {
				return "04";
			}
		}
		return "01";
	...
	public static String getDsfIdcT(String idcType) {
		if (!Strings.isNullOrEmpty(idcType)) {
			String idcT = idcType.replaceAll("IdcardType.", "");
			if ("01".equals(idcT)) {
				return "0";
	...
	public static String getDnaCurrencyType(String ct) {
		if (!Strings.isNullOrEmpty(ct)) {
			if ("01".equals(ct)) {
				return "CurrencyType.CNY";
			} else if ("02".equals(ct)) {
				return "CurrencyType.HKD";
			} else if ("03".equals(ct)) {
				return "CurrencyType.MOP";
			} else if ("04".equals(ct)) {
				return "CurrencyType.TWD";
			} else if ("05".equals(ct)) {
				return "CurrencyType.MYR";
			} else if ("06".equals(ct)) {
				return "CurrencyType.KPW";
			} else if ("07".equals(ct)) {
				return "CurrencyType.THB";
			} else if ("08".equals(ct)) {
				return "CurrencyType.USD";
			} else if ("09".equals(ct)) {
				return "CurrencyType.JPY";
			} else if ("10".equals(ct)) {
				return "CurrencyType.KRW";
			} else if ("11".equals(ct)) {
				return "CurrencyType.SGD";
			} else if ("12".equals(ct)) {
				return "CurrencyType.EUR";
			} else if ("13".equals(ct)) {
	...
	public static String getDnaCurrencyType2Num(String ct) {
		if (!Strings.isNullOrEmpty(ct)) {
			if ("CurrencyType.CNY".equals(ct)) {
				return "01";
			} else if ("CurrencyType.HKD".equals(ct)) {
				return "02";
			} else if ("CurrencyType.MOP".equals(ct)) {
				return "03";
			} else if ("CurrencyType.TWD".equals(ct)) {
				return "04";
			} else if ("CurrencyType.MYR".equals(ct)) {
				return "05";
			} else if ("CurrencyType.KPW".equals(ct)) {
				return "06";
			} else if ("CurrencyType.THB".equals(ct)) {
				return "07";
			} else if ("CurrencyType.USD".equals(ct)) {
				return "08";
			} else if ("CurrencyType.JPY".equals(ct)) {
				return "09";
			} else if ("CurrencyType.KRW".equals(ct)) {
				return "10";
			} else if ("CurrencyType.SGD".equals(ct)) {
				return "11";
			} else if ("CurrencyType.EUR".equals(ct)) {
				return "12";
			} else if ("CurrencyType.GBP".equals(ct)) {
				return "13";
			}
		}
		return "01";
	...
	public static String getMonetaryUnit(String currencyType) {
		// ����� �۱� ���ű� ̨�� ��Ԫ ���� ̩�� ��Ԫ ��Ԫ ���� ��Ԫ ŷԪ Ӣ��
		// CNY HKD MOP TWD MYR KPW THB USD JPY KRW SGD EUR GBP
		if (currencyType.equals("01")) {
			return "Ԫ";
